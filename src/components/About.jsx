                ...
                <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                    <div className='grid grid-cols-2 gap-6 md:gap-10 w-full 2xl:pr-28'>
                        ...
                        <div>
                            ...
                            <p>ModuleNode. Sq. Ft. Delivered</p>
                        </div>
                        <div>
                    ...
                    <p className='my-10 max-w-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus odio minus quam doloribus culpa nesciunt minima ipsa tempora distinctio exercitationem ad iure, unde pariatur, velit ex omnis adipisci earum sed rerum provident nobis. Tempora rem ab voluptatibus numquam voluptatem maiores amet dolore voluptatum.</p>
